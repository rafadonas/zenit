...
import '../sync_center/sync_status_presentation.dart';
              ...
              if (!plan.canRunDemoRehearsal)
                ...
                for (final event in events)
                  ListTile(
                    dense: true,
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(syncStateIcon(event.syncState)),
                    title: Text(
                      '${_mowingOperationLabel(event.operation)}: ${syncStateLabel(event.syncState)}',
                    ),
                ...
                for (final measurement in measurements)
                  ListTile(
                    dense: true,
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(syncStateIcon(measurement.syncState)),
                    title: Text(
                      'Pós-serviço ${measurement.sequence}: ${measurement.heightCm} cm · ${syncStateLabel(measurement.syncState)}',
                    ),
                    subtitle: Text(
                ...
                for (final photo in photos)
                  ListTile(
                    ...
                    leading: Icon(
                      photo.isUploaded
                          ? Icons.cloud_done
                          : syncStateIcon(photo.syncState),
                    ),
                    title: Text(
                      'Foto pós-serviço ${photo.sequence}: ${photo.isUploaded ? 'conteúdo recebido, não validado' : syncStateLabel(photo.syncState)}',
                    ),
                    subtitle: Text(
