              ...
              if (drafts.length == 3 && lifecycle.length == 3) ...[
                ...
                for (final event in lifecycle)
                  ListTile(
                    ...
                    title: Text(
                      ...
                      '${syncStateLabel(event.syncState)}',
                    ),
                ...
                for (final draft in drafts)
                  ListTile(
                    dense: true,
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(syncStateIcon(draft.syncState)),
                    title: Text(
                      'Ponto ${draft.sequence}: ${syncStateLabel(draft.syncState)}',
                    ),
                ...
                for (final photo in photos)
                  ListTile(
                    dense: true,
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(syncStateIcon(photo.syncState)),
                    title: Text(
                      'Foto ${photo.sequence}: ${photo.isUploaded ? 'conteúdo recebido, não validado' : syncStateLabel(photo.syncState)}',
                    ),
                    subtitle: Text(
