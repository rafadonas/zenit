...
export default async function MowingPostServiceSummariesPage({ searchParams }: PageProps) {
  const [session, summaries, query] = await Promise.all([
    loadDashboardSession(), loadSummaries(), searchParams,
  ]);
