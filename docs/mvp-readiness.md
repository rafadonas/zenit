...
| --- | --- | --- |
| Reproducible foundation | Ready | Compose defines healthy PostgreSQL/PostGIS, MinIO, API, and dashboard services. Dashboard readiness fails closed when its server-side API dependency is unavailable. A fresh database applies migrations `0001`-`0041`. |
...
fresh PostgreSQL initialization with migrations 0001-0041
